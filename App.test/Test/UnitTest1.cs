...
namespace RouteFinder.Tests
{
    ...
    public class RouteFinderTests
    {
        ...
        private RouteFinderHelper _helper;
        ...
        public void FindBestRoute_ThreePoints_ReturnsCorrectRouteAndDistance()
        {
            ...
            Assert.IsNotNull(_helper, "Helper не инициализирован");
    ...
    /// <summary>
    /// Вспомогательный класс для тестирования, нестатический для возможности создания экземпляра
    /// </summary>
